...
class FaculteResourceIT {
    ...
    public static Faculte createEntity(EntityManager em) {
        Faculte faculte = new Faculte().nom(DEFAULT_NOM);
        return faculte;
    }
    ...
    public static Faculte createUpdatedEntity(EntityManager em) {
        Faculte faculte = new Faculte().nom(UPDATED_NOM);
        return faculte;
    }
    ...
    void createFaculte() throws Exception {
        ...
        assertThat(testFaculte.getNom()).isEqualTo(DEFAULT_NOM);
    }
    ...
    @Test
    @Transactional
    void putNewFaculte() throws Exception {
        // Initialize the database
        faculteRepository.saveAndFlush(faculte);
        ...
        updatedFaculte.nom(UPDATED_NOM);
        ...
        Faculte testFaculte = faculteList.get(faculteList.size() - 1);
        assertThat(testFaculte.getNom()).isEqualTo(UPDATED_NOM);
    }
    ...
    void partialUpdateFaculteWithPatch() throws Exception {
        ...
        partialUpdatedFaculte.nom(UPDATED_NOM);

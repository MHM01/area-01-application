...
describe('Faculte routing resolve service', () => {
  ...
  let resultFaculte: IFaculte | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IFaculte if id is not provided', () => {
      // GIVEN
      ...
      expect(resultFaculte).toEqual(new Faculte());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Faculte })));
      mockActivatedRouteSnapshot.params = { id: 123 };
